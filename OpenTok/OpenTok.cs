...
namespace OpenTokSDK
{
    ...
    public partial class OpenTok
    {
        ...
        /// <param name="hasTranscription"></param>
        /// <param name="transcriptionProperties"></param>
        /// <returns>
        /// The Archive object. This object includes properties defining the archive, including the archive ID.
        /// </returns>
        public Archive StartArchive(string sessionId, string name = "", bool hasVideo = true, bool hasAudio = true, OutputMode outputMode = OutputMode.COMPOSED, string resolution = null, ArchiveLayout layout = null, StreamMode? streamMode = null, string multiArchiveTag = null, int? maxBitrate = null, int? quantizationParameter = null, bool hasTranscription = false, TranscriptionProperties? transcriptionProperties = null)
        {
            if (string.IsNullOrEmpty(sessionId))
            {
            ...
            if (hasTranscription)
            {
                data.Add("hasTranscription", true);
            }

            if (transcriptionProperties.HasValue)
            {
                data.Add("transcriptionProperties", transcriptionProperties.Value);
            }
